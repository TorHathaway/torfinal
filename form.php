...
if (isset($_POST["btnSubmit"])) {
    ...
    if (!$errorMsg) {
        ...
        $cc = "";
        $bcc = "";
        $from = "<tyler.t.hathaway@uvm.edu>";
        // subject of mail should make sense to your form
        $todaysDate = strftime("%x");
        $subject = "Tor Hathaway Mailing List: " . $todaysDate;
            ...
            <fieldset class="wrapper">
                ...
                <fieldset class="wrapperTwo">
                    ...
                    <fieldset class="checkbox">
                        ...
                        <legend>What is your favorite winter sport? (check all that apply):</legend>
                            <label><input type="checkbox" 
                                          id="chkHiking" 
                                          name="chkHiking" 
                                          value="Skiing"
                                          <?php if ($hiking) print " checked "; ?>
                                          tabindex="420"> Skiing</label>
                            ...
                            <label><input type="checkbox" 
                                          ...
                                          tabindex="430"> Snowboard</label>
                        
                            <label><input type="checkbox" 
                                          id="chSkating" 
                                          name="chkSkating" 
                                          value="Ice Skating"
                                          <?php if ($skating)  print " checked "; ?>
                                          tabindex="430"> Ice Skating </label>
                        
                        
                    </fieldset> <!-- End of Check Boxes-->
                    ...
                    <fieldset class="radio">
                        <legend>What gender are you?</legend>
                            <label><input type="radio" 
                                          ...
                                          name="radGender" 
                                          value="Male"
                                          <?php if ($gender == "Ski") print 'checked' ?>
                                          tabindex="330">Male</label>
                            <label><input type="radio" 
                                          id="radGenderFemale" 
                                          name="radGender" 
                                          value="Female"
                                          <?php if ($gender == "Snowboard") print 'checked' ?>
